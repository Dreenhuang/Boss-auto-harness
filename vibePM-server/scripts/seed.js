...
async function seed() {
  ...
  if (pathsError) console.error('Paths seed error:', pathsError.message)
  else console.log('✅ Learning paths seeded')
  ...
  if (stepsError) console.error('Steps seed error:', stepsError.message)
  else console.log('✅ Learning steps seeded')
  ...
  if (hotError) console.error('Hot searches seed error:', hotError.message)
  ...
  if (msgError) console.error('Messages seed error:', msgError.message)
