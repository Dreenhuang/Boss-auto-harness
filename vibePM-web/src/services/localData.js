...
const LOCAL_MESSAGES = [
  { id: '1', type: 'private', name: '架构师老王', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=arch', bgColor: '#F0F0F0', content: '老弟，上次那个 API 的方案发我一份？', time: '3分钟前', unread: true },
  { id: '2', type: 'private', name: '职场导师Lily', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=lily', bgColor: '#E0E0E0', content: '你的学习计划已经制定好了，记得查看。', time: '1小时前', unread: false },
  { id: '3', type: 'system', name: '系统通知', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=sys', bgColor: '#D0D0D0', content: '欢迎加入 Vibe PM！开启你的 AI 学习之旅。', time: '2小时前', unread: false },
  { id: '4', type: 'interaction', name: '技术小白', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=tech', bgColor: '#C0C0C0', content: '赞了你的笔记《API 就像餐厅服务员》', time: '5小时前', unread: true },
  { id: '5', type: 'follow', name: '码农小张', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=dev', bgColor: '#B0B0B0', content: '开始关注了你', time: '1天前', unread: true },
  { id: '6', type: 'comment', name: 'AI探索者', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ai', bgColor: '#A0A0A0', content: '在评论中回复了你：这个比喻太妙了！', time: '2天前', unread: false }
]
